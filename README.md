...
| **저상버스 (서울)** | [서울특별시_버스도착정보조회 서비스](https://www.data.go.kr/data/15000314/openapi.do) <br/>`15000314` · `ws.bus.go.kr` | `arrive/getLowArrInfoByStId` | 구현 완료 · **활용신청 승인 대기**<br/>미승인 시 "저상 정보 없음" 폴백 |
| **정류소 검색 (서울)** | [서울특별시_정류소정보조회 서비스](https://www.data.go.kr/data/15000303/openapi.do) <br/>`15000303` · `ws.bus.go.kr` | `stationinfo/getStationByPos` | 위와 동일 (서울 어댑터는 2건 모두 필요) |
